...
# 建议在青龙面板的【环境变量】中配置以下变量 ROCOM_API_KEY

#本项目的数据源由 https://github.com/Entropy-Increase-Team 提供。 你需要前往该项目主页或相关社区，获取用于调用 WeGame 接口的 ROCOM_API_KEY
